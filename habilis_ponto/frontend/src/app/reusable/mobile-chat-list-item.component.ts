...
@Component({
  selector: 'app-mobile-chat-list-item',
  templateUrl: 'mobile-chat-list-item.component.html',
  styleUrls: ['mobile-chat-list-item.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MobileChatListItemComponent implements OnChanges {
  ...
  constructor(public sanitizer: DomSanitizer, public status: StatusService, private actions: ActionsService) {
  ...
  buttonClick(button) {
    this.clearButton();
    this['onButton' + button + 'Click'].emit(this.chat);
  }
